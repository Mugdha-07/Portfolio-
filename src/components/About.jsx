        ...
        <Container>
          ...
          <Flex className="justify-around flex-wrap">
            ...
            <div className="lg:w-[45%] w-full lg:mt-[70px] mt-6 ">
              <div className="lg:flex justify-around ">
                <div className="w-[45%] ">
                  <div className="">
                    <h2 className='font-serif font-medium text-[16px] text-[#616D7E]  '>First Name : <span className='text-[#000] font-semibold text-[18px]'>Mugdha </span></h2>
                  </div>
                  <div className="py-[20px]">
                    <h2 className='font-serif font-medium text-[16px] text-[#616D7E]  '>Last Name : <span className='text-[#000] font-semibold text-[18px]'>Roy </span></h2>
                  </div>
                  <div className="py-[20px]">
                    <h2 className='font-serif font-medium text-[16px] text-[#616D7E]  '>Age : <span className='text-[#000] font-semibold text-[18px]'>21 </span></h2>
                  </div>

                  <div className="py-[20px]">
                  <h2 className='font-serif font-medium text-[16px] text-[#616D7E]  '> Phone : <span className='text-[#000] font-semibold text-[18px]'>01830875982 </span></h2>
                    
                  </div>
                </div>
                <div className="w-[45%]">
                  <div className="">
                    <h2 className='font-serif font-medium text-[16px] text-[#616D7E]  '>Address : <span className='text-[#000] font-semibold text-[18px]'>Barisal</span></h2>
                  </div>
                  <div className="py-[20px]">
          ...
          <div className="lg:flex justify-around">
            <div className="lg:w-[45%] w-full mt-10">
              ...
              <div className="h-[35px] w-[100%] border-[5px] border-[#000] text-center rounded-full  relative ">
